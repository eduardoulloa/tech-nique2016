...
<?php get_header();  $left=true;?>
		...
		<?php } ?>
		<div class="topbanner advice-banner"></div>
		<div class="below-content"></div>
		<div class="grid-container">
		
			<div class="left-content">
			<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('advice-sidebar') ) : 
			endif; ?>			
			</div>
        ...
        <?php if (have_posts()) { ?>
			<?php while (have_posts()) { the_post(); ?>												
				...
				<article <?php post_class() ?> style="margin-top:20px;">
